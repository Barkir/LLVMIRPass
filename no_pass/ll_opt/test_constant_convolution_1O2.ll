; ModuleID = './CollapseIdenticalNodesTests/ll/test_constant_convolution_1.ll'
source_filename = "./CollapseIdenticalNodesTests/cpp/test_constant_convolution_1.cpp"
...
entry:
  ...
  %mul = mul nsw i32 %b, %a
  %retval.0 = select i1 %or.cond1, i32 266257770, i32 %mul
  ret i32 %retval.0
}
