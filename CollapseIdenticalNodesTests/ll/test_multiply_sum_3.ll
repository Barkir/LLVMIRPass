; ModuleID = './CollapseIdenticalNodesTests/cpp/test_multiply_sum_3.cpp'
source_filename = "./CollapseIdenticalNodesTests/cpp/test_multiply_sum_3.cpp"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Function Attrs: mustprogress noinline nounwind uwtable
define dso_local noundef i32 @_Z9mul_intV4iiii(i32 noundef %a, i32 noundef %b, i32 noundef %c, i32 noundef %d) #0 {
entry:
...
if.else:                                          ; preds = %land.lhs.true2, %land.lhs.true, %entry
  ...
  %mul7 = mul nsw i32 %mul6, %10
  %11 = load i32, ptr %d.addr, align 4
  %add8 = add nsw i32 %mul7, %11
  store i32 %add8, ptr %res, align 4
  br label %if.end
